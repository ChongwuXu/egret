...
var WochengSDK = function () {
    function k() {
        ...
        if (window.XMLHttpRequest)
            b = new XMLHttpRequest, b.overrideMimeType && b.overrideMimeType("text/xml");
        ...
        if (null != a) {
            ...
            a.onreadystatechange = function () {
                if (4 == a.readyState)
                    if (200 ==
                        a.status)
                        clearTimeout(e), d("[Get\u8bf7\u6c42\u6210\u529f]"), c(1);
                    else if (r++, r == vacIP.length)
                        d("ip\u5207\u6362\u7ed3\u675f"), c(0);
                    else {
    ...
    function G(b, g, c) {
        ...
        if (null != a) {
            ...
            a.onreadystatechange = function () {
                if (4 == a.readyState)
                    if (200 == a.status)
                        clearTimeout(e), d("[Get\u8bf7\u6c42\u6210\u529f]"), c(1, a.responseText);
                    else if (u++, u == vacIP.length)
                        d("ip\u5207\u6362\u7ed3\u675f"), c(0, '{"result":0,"errcode":"301"}');
                    else {
                        var f = b.replace(vacIP[u - 1], vacIP[u]);
                        d(f);
                        G(f, g, c);
                    }
            };
    ...
    function J(b, g, c) {
        ...
        if (null != a) {
            ...
            a.onreadystatechange = function () {
                if (4 == a.readyState)
                    if (200 == a.status)
                        clearTimeout(e), d("[POST\u8bf7\u6c42\u6210\u529f]"), c(1, a.responseText);
                    else if (v++, v == vacIP.length)
                        d("ip\u5207\u6362\u7ed3\u675f"), c(0, '{"result":0,"errcode":"301"}');
                    else {
            ...
            e.onreadystatechange = function () {
                ...
                if (4 == e.readyState)
                    if (200 == e.status) {
                        ...
                        l++, l == payIP.length ? (d("\u53d1\u9001\u8ba1\u8d39\u8bf7\u6c42 \u7b2c\u4e00\u4e8c\u6b65\u90fd\u5931\u8d25 B"), a(0, "out of service")) : (h = b.replace(payIP[l - 1], payIP[l]), z(h, g, c, a));
                else
                    a(0, "out of service");
            };
            e.send(g);
            ...
            e.onreadystatechange = function () {
                if (4 == e.readyState)
                    if (200 == e.status) {
                        ...
                        n++, n == vacIP.length ? (d("ip\u5207\u6362\u7ed3\u675f"), a(0, "out of service")) : (h = b.replace(vacIP[n - 1], vacIP[n]), y(h, g, c, a));
            };
            e.send(g);
        }
    }
    ...
    this.doOrderProduct = function (b, g, c, a, e, f, h, I, k, r, t, u, v, p, q, w, x, A, B, C, D, m) {
        b || (b = "unknown");
        g || (g = "unknown");
        c ? a ? e ? f ? h ? I ? (p || (p = "unknown"), q || (q = "unknown"), w || (w = "unknown"), x ? A ? B ? C ? D ? (d("payVersion:" + x), d("payChannelId:" + A), d("payAppId:" + B), d("payAppName:" + C), d("payUA:" + D), n = 0, b = "http://vacIP:12324/api/v1.0/buyOrder".replace(/vacIP/, vacIP[n]) + "/" + b + "/" + a + "/" + e + "/" + c + "/" + g + "/" + p + "/" + q + "?platform=" + w, d("\u4e0b\u8ba2\u5355:" + b), y(b, null, !0, function (a, b) {
        ...
        if (b)
            if (g) {
                ...
                for (var h = "", f = 0; f < c.length; f++)
                    h = f == c.length - 1 ? h + c[f] : h + (c[f] + "-");
                c = "";
                for (f = 0; f < e.length; f++)
                    c = f == e.length - 1 ? c + e[f] : c + (e[f] + "-");
                q = 0;
                ...
                d(0, "customerId error");
        else
            d(0, "contentId is empty");
    };
    ...
    this.doCheckNetwork = function (b) {
        r = 0;
        E("http://vacIP:12324/api/v1.0/order/111".replace(/vacIP/, vacIP[r]), !0, function (g) {
